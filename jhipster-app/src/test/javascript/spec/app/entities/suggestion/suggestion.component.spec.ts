...
import { SuggestionComponent } from 'app/entities/suggestion/suggestion.component';
...
describe('Component Tests', () => {
  describe('Suggestion Management Component', () => {
    let comp: SuggestionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SuggestionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.suggestions && comp.suggestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
