package org.jhipster.fitcallab.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.jhipster.fitcallab.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.jhipster.fitcallab.repository.UserRepository.USERS_BY_EMAIL_CACHE);
